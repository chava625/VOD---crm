    ...
    function initSuperModal(selector,settings) {
        ...
        if (modalHtml) {
            ...
            if (localSettings.closeButton) {
                $(modalSelector+' .supermodal-window .supermodal-title').prepend('<div class="supermodal-close"><i class="fa fa-times" aria-hidden="true"></i></div>');
            }
            ...
            $(modalSelector+' .supermodal-window .supermodal-title').css('background','tomato');
